...
1. **TechCorp_I_Robert_Joh.sol** - Solidity smart contract (91 lines)
2. **TechCorp_I_Robert_Joh.abi.json** - Contract ABI (8 elements)
...
### MCP Server
5. **TechCorp_I_Robert_Joh_mcp_server.py** - Custom MCP server (70 lines)
